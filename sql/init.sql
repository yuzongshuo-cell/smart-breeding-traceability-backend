/*
 ...
 Source Schema         : pts_source

 Target Server Type    : MySQL
 Target Server Version : 80028
 File Encoding         : 65001

 Date: 07/07/2023 13:04:19
*/
...
CREATE TABLE `base_account`  (
  ...
  `photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '头像照片',
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '邮箱',
  `mobile` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '手机号',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '状态  0：禁用   1：正常',
  PRIMARY KEY (`account_id`) USING BTREE,
  UNIQUE INDEX `username`(`username`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统账号表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_log`  (
  `log_id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `log_username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '访问用户账号',
  `log_host` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '访问IP地址',
  `log_realname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '访问用户真实姓名',
  `log_request_method` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '请求的方式，get post delete put',
  `log_request_uri` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '请求的地址',
  `log_time` datetime(0) NULL DEFAULT NULL COMMENT '请求的时间',
  PRIMARY KEY (`log_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '日志信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `disease_record`  (
  `dr_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '记录id',
  `dr_animal_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '动物编号',
  `dr_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '症状描述',
  `dr_cure` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '治疗过程描述',
  `dr_time` datetime(0) NULL DEFAULT NULL COMMENT '治疗时间',
  `dr_status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT ' 未治疗,治疗中,已治疗',
  `dr_d_id` int(0) NULL DEFAULT NULL COMMENT '病症类型id',
  PRIMARY KEY (`dr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '疾病记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `index_record`  (
  `ird_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '记录id',
  `ird_weight` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '重量',
  `ird_time` datetime(0) NULL DEFAULT NULL COMMENT '记录时间',
  `ird_healthy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否健康 健康,不健康',
  `ird_temperature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '体温',
  `ird_breathing` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '呼吸频率',
  `ird_heart_rate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '心率',
  `ird_animal_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '动物外键',
  PRIMARY KEY (`ird_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '动物指标记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `issue_record`  (
  `isr_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '记录id',
  `isr_time` datetime(0) NULL DEFAULT NULL COMMENT '出单时间',
  `isr_num` int(0) NULL DEFAULT NULL COMMENT '购买数量',
  `isr_price` double NULL DEFAULT NULL COMMENT '单价',
  `isr_deliver` datetime(0) NULL DEFAULT NULL COMMENT '交付时间',
  `isr_status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '申请中,已出库,已完成',
  `isr_customer_id` int(0) NULL DEFAULT NULL COMMENT '客户id',
  PRIMARY KEY (`isr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '出单记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `manager_animal`  (
  ...
  `a_weight` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '动物体重',
  `a_gender` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '动物性别,雌性，雄性',
  `a_healthy` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '健康状态,健康,生病',
  `a_status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '过程状态,养殖中，已检疫，已出栏，已屠宰，已入库，已销售',
  `a_inoculate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '疫苗接种状态未接种,已接种',
  `a_time` datetime(0) NULL DEFAULT NULL COMMENT '录入时间',
  `a_batch_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '批次外键',
  `a_hurdles_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '栏圈外键',
  PRIMARY KEY (`a_animal_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '动物信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `manager_animal` VALUES ('24a0eb148f1a4a1cb79cb60ab12328eb', '46', '雄性', '健康', '已检疫', '未接种', '2022-06-05 22:48:10', '1504f25bb8c4401cbce2a06dfe8a5c51', '8e4766be9bc1437d920458793ecf1f6d');
...
CREATE TABLE `manager_batch`  (
  ...
  `b_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '批次描述',
  `b_quarantine` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '检疫状态,未检疫已检疫',
  `b_qualified` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '检疫合格状态,合格不合格',
  `b_time` datetime(0) NULL DEFAULT NULL COMMENT '批次时间',
...
INSERT INTO `manager_batch` VALUES ('67182782d61e452184e9004f9ed3072f', '2022年3月第一批次', '未检疫', '合格', '2022-04-13 14:39:53');
INSERT INTO `manager_batch` VALUES ('920d3d09c01542a987d1ab367526bc06', '2022年7月第一批次', '未检疫', '合格', '2022-06-14 11:04:03');
INSERT INTO `manager_batch` VALUES ('977377d225ff484c8410c0f18db28ed0', '2022年11月第一批次', '未检疫', '合格', '2022-11-01 19:38:44');
...
CREATE TABLE `manager_disease`  (
  `d_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '病症id',
  `d_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '病症名称',
  `d_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '病症描述',
  `d_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '病症类型',
  `d_etiology` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '病源',
  `d_symptom` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '症状',
  `d_prevention` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '预防方式',
  PRIMARY KEY (`d_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '疾病类型表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `manager_fence_house`  (
  ...
  `fh_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '栏舍描述',
  `fh_time` datetime(0) NULL DEFAULT NULL COMMENT '栏舍创建时间',
  PRIMARY KEY (`fh_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '栏舍信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `manager_freezer`  (
  `fz_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '冷库id',
  `fz_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '冷库名称',
  `fz_num` int(0) NULL DEFAULT NULL COMMENT '冷库总量',
  `fz_area` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '冷库面积',
  `fz_quantity` int(0) UNSIGNED NULL DEFAULT NULL COMMENT '冷库以存量',
  `fz_temperature` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '冷库最佳温度',
  `fz_humidity` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '冷库最佳湿度',
  PRIMARY KEY (`fz_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '冷库信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `manager_hurdles`  (
  ...
  `h_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '栏圈描述',
  `h_max` int(0) UNSIGNED NOT NULL COMMENT '栏圈存储猪容量',
  `h_saved` int(0) UNSIGNED NOT NULL COMMENT '栏圈存储猪已存数量',
  `h_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `h_enable` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '状态(可用禁用)',
  `h_full` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '状态(未满已满)',
  `h_fence_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '栏舍id外键',
  PRIMARY KEY (`h_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '栏圈信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of manager_hurdles
-- ----------------------------
INSERT INTO `manager_hurdles` VALUES ('429b226d6f7e43339841b44875c672f7', '隔离3号圈', '隔离3号圈描述', 30, 0, '2022-04-13 06:37:30', '可用', '未满', '12e4f043910a4b7a9ad933f90fec620c');
INSERT INTO `manager_hurdles` VALUES ('4a1faf8f29d24766bc0be1a304615e04', '隔离2号圈', '隔离2号圈描述', 30, 0, '2022-04-13 06:36:55', '可用', '未满', '12e4f043910a4b7a9ad933f90fec620c');
INSERT INTO `manager_hurdles` VALUES ('6a82f8b27eab4b908f50ec6f090dcd20', '育成4号圈', '育成4号圈描述', 30, 0, '2022-04-13 06:37:04', '可用', '未满', '851d58388f974d95b6c67d93189b7222');
...
INSERT INTO `manager_hurdles` VALUES ('8e4766be9bc1437d920458793ecf1f6d', '育成1号圈', '育成1号圈描述', 30, 6, '2022-04-13 06:35:04', '可用', '未满', '851d58388f974d95b6c67d93189b7222');
...
CREATE TABLE `manager_qrcode`  (
  `q_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `q_animal_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '动物编号',
  `q_image_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '二维码图片地址',
  PRIMARY KEY (`q_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '溯源二维码信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of manager_qrcode
-- ----------------------------
INSERT INTO `manager_qrcode` VALUES (1, '000cec87a71d41cebf0eabf38f6054f4', 'http://127.0.0.1:8082/image/9185a1be-f294-4305-9b95-96cdf101d128.jpg');
INSERT INTO `manager_qrcode` VALUES (2, '0a4c5c17a4014232924ba1d4a1a00aa3', 'http://127.0.0.1:8082/image/488fce45-6110-466a-a325-495c869f92a7.jpg');
INSERT INTO `manager_qrcode` VALUES (3, '1335514f030e4c73931fd6422959934a', 'http://127.0.0.1:8082/image/784302e6-f920-4dc9-9931-f106ab6e9e32.jpg');
INSERT INTO `manager_qrcode` VALUES (4, '192998856dd24f1bbfd1ede2967e8075', 'http://127.0.0.1:8082/image/58eaa2da-8df6-4978-a8fe-439a410c9f2a.jpg');
...
CREATE TABLE `quarantine_registration`  (
  `gr_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '记录id',
  `gr_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '检疫时间',
  `gr_img` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '检疫证明图片',
  `gr_mechanism` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '检疫机构',
  `gr_batch_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '批次id',
  `b_qualified` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '不合格' COMMENT '检疫结果',
  PRIMARY KEY (`gr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '检疫登记' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of quarantine_registration
-- ----------------------------
INSERT INTO `quarantine_registration` VALUES (12, '2022-05-04 19:47:00', 'http://121.224.77.1:9527/image/BBkoGKU61uAHtmRAAQGQQOeTiE068.png', '防疫站', '36bbbeb5836e43de80c15401d206b5ce', '合格');
INSERT INTO `quarantine_registration` VALUES (13, '2022-05-07 10:45:51', 'http://121.224.77.1:9527/image/BBkoGKU61WADzr_AARGBhJL29M867.png', '防疫站', 'ffb95f211b874a778844857ff1e5141f', '合格');
INSERT INTO `quarantine_registration` VALUES (14, '2022-05-11 21:39:36', 'http://121.224.77.1:9527/image/BBkoGKU60SASTitAAQGQQOeTiE082.png', '防疫站', '75fa8762d655461ab90799a20ae282af', '合格');
